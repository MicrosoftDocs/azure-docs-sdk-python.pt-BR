...
Os exemplos de código para criar vários tipos comuns de clusters HDInsight estão disponíveis: [Exemplos de HDInsight para Python](https://github.com/Azure-Samples/hdinsight-python-sdk-samples).
